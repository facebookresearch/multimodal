...
import numpy as np
import torch
from examples.mdetr.datasets.datamodule import FlickrDataModule
from examples.mdetr.datasets.flickr_eval import FlickrEvaluator
...
def evaluate(
    ...
    for batch_dict in metric_logger.log_every(data_loader, 10, header):
        ...
        # # TODO: once we use Lightning this can go in before_batch_transfer hook
        # tokenizer = data_loader.dataset.prepare.tokenizer
